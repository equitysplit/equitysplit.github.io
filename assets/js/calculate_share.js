...
function removeRow() {
	for (i = document.getElementById("cal_table_id").rows.length -2 ; i >= 2; i--) { 
		...
		if (x.style.display == 'table-row') {
			...
			resetSpecificDataRow(i);
			break;
		}
	}
}

function resetSpecificDataRow(row) {
	document.forms[0].elements['member' + row + '_name'].value = "";
	document.forms[0].elements['member' + row + '_ysc'].value = "";
	document.forms[0].elements['member' + row + '_yss'].value = "";
	document.forms[0].elements['member' + row + '_ysp'].value = "";
	document.forms[0].elements['member' + row + '_nc'].value = "";
	document.forms[0].elements['member' + row + '_ic'].value = "0";
	document.forms[0].elements['member' + row + '_djtp'].value = "2017/03/11";
	document.forms[0].elements['member' + row + '_dotp'].value = "";
	document.forms[0].elements['member' + row + '_vt'].value = "";
	document.forms[0].elements['member' + row + '_hw'].value = "30";
	document.forms[0].elements['member' + row + '_ie'].value = "";
	document.forms[0].elements['member' + row + '_ocs'].value = "100,000";
	document.forms[0].elements['member' + row + '_sph'].value = "";
}
...
function calculation(form) {
	...
	for (i = 1; i < document.getElementById("cal_table_id").rows.length - 1; i++) { 
		...
		if (x.style.display == 'table-row') {
			...
			switch(i) {
				case 1:
					/* member 1 */
					contributionCase = parseFloat(form.member1_ic.value.replace(/,/g, ''), 10);
				...
				case 2:
					/* member 2 */
					contributionCase = parseFloat(form.member2_ic.value.replace(/,/g, ''), 10);
				...
				case 3:
					/* member 3 */
					contributionCase = parseFloat(form.member3_ic.value.replace(/,/g, ''), 10);
				...
				case 4:
					/* member 4 */
					contributionCase = parseFloat(form.member4_ic.value.replace(/,/g, ''), 10);
				...
				case 5:
					/* member 5 */
					contributionCase = parseFloat(form.member5_ic.value.replace(/,/g, ''), 10);
				...
				case 6:
					/* member 6 */
					contributionCase = parseFloat(form.member6_ic.value.replace(/,/g, ''), 10);
				...
				case 7:
					/* member 7 */
					contributionCase = parseFloat(form.member7_ic.value.replace(/,/g, ''), 10);
				...
				case 8:
					/* member 8 */
					contributionCase = parseFloat(form.member8_ic.value.replace(/,/g, ''), 10);
				...
				case 9:
					/* member 9 */
					contributionCase = parseFloat(form.member9_ic.value.replace(/,/g, ''), 10);
	...
	total_cash_sign = parseFloat(form.member999_yss.value.replace(/,/g, ''), 10);
	for (i = 1; i < document.getElementById("cal_table_id").rows.length - 1; i++) { 
		var x = document.getElementById('tr_id_' + i);
		if (x.style.display == 'table-row') {
			switch(i) {
				case 1:
					...
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member1_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member1_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 2:
					form.member2_ysp.value = Number((parseFloat(form.member2_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member2_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member2_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 3:
					form.member3_ysp.value = Number((parseFloat(form.member3_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member3_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member3_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 4:
					form.member4_ysp.value = Number((parseFloat(form.member4_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member4_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member4_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 5:
					form.member5_ysp.value = Number((parseFloat(form.member5_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member5_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member5_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 6:
					form.member6_ysp.value = Number((parseFloat(form.member6_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member6_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member6_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 7:
					form.member7_ysp.value = Number((parseFloat(form.member7_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member7_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member7_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 8:
					form.member8_ysp.value = Number((parseFloat(form.member8_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member8_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member8_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
				case 9:
					form.member9_ysp.value = Number((parseFloat(form.member9_ysc.value.replace(/,/g, ''), 10) * 100) / total).toFixed(2);
					if(!isNaN(total_cash_sign)) {
						var temp = (parseFloat(form.member9_ysp.value.replace(/,/g, ''), 10) * total_cash_sign) / 100;
						form.member9_yss.value = Number(Number(temp).toFixed(2)).toLocaleString("en");
					}
					break;
			}
		}
